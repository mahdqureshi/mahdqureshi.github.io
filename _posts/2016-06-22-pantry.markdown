...
<p class="project-body">Amongst the many questions that arose, an example of one was: How do we define a meal? 
<br>
Initially, when adding a meal to a meal plan, it would then automatically appear on the nutritionists ‘Recipes’ page. But after testing, it became clear that many meals weren’t necessarily ‘recipes’. Often, they consisted of solely ingredients—like a cup of almonds.</p>

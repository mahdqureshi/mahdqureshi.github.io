...
<br>
<p class="project-body">Initially, when adding a meal to a meal plan, the meal would automatically appear on the nutritionists ‘Recipes’ page. But after testing, it became clear that many meals weren’t necessarily ‘recipes’. Often, they consisted of only ingredients—like a cup of almonds.</p>

<p class="project-body">After further testing, I decided that it wasn’t valuable for the recipes page to be populated with these 'Simple Meals' posing as ‘Recipes’. So I decided that only meals with instructions and a how-to video would appear there.</p>
<br>
<br>

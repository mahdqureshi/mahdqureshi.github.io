...
<p class="project-body">Initially, when creating a meal for a meal plan, it would also automatically appear on the creators ‘Recipes’ view. These recipes would also be discoverable on the home feed.</p>

![pantry recipes view](/img/recipes_profile.png)

<p class="project-body">After testing, I discovered that many meals weren’t necessarily ‘recipes’. Often, they consisted of solely ingredients—like a cup of almonds. After iterating on different solutions, I landed on treating only meals with instructions as a recipe. Simple, ingredient-only meals would be contained within the meal plan.</p>
<br>
<br>

![pantry tab bar wireframe](/img/pantry_flowmap.png)
<br>
<div class="caption">Mapping out the logic of a user adding the ‘Ingredient Only Meal’.</div>

<hr>

<p class="project-body">Specifying component states for engineering.</p>

![pantry tab bar wireframe](/img/nav-menu.png)
![pantry tab bar wireframe](/img/payouts.png)
![pantry tab bar wireframe](/img/subscriptions.png)

...
<div class="row">
  ...
  <div class="col-sm-6">
  <p>Once of the main problems facing nutritionists is managing their clients. Almost all still manage them via creating PDF meal plans and sending them via email or text message. There was also a lack of network effects.</p>
  </div>
</div>

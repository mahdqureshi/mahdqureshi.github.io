...
<br>
<p class="project-body">Initially, when adding a meal to a meal plan, the meal would automatically appear on the coaches ‘Recipes’ page. But after testing, it became clear that many meals in a plan weren’t necessarily ‘recipes’. Many consisted of just ingredients—like A Cup of Almonds. After further testing, I decided that it wasn’t valuable for the coaches recipes page be filled with these 'Simple Meals' posing as ‘Recipes’. Only meals with instructions and a video would appear there.</p>
<br>
<br>
...
<img class="bigimg" src="/img/pantry_flowmap.png" alt="pantry tab bar wireframe">

...
<div class="row">
  ...
  <div class="col-sm-8">
  <p>A major problem facing creators and nutritionists is finding and managing clients. The ecosystem is still driven by word of mouth, with meal plans still being sent as PDFs through email. Coaching is often done through text messaging. Platforms like Kajabi clearly weren't solving the problem.</p>
  </div>
</div>
...
# Problem Snippet: Meal vs Recipe

<p class="project-body">One of the many questions that arose during the design was: How do we define a meal vs a recipe?</p>
<p class="project-body">Initially, when adding a meal to a meal plan, it would then automatically appear on the creators ‘Recipes’ view. But after testing, it became clear that many meals weren’t necessarily ‘recipes’. Often, they consisted of solely ingredients—like a cup of almonds.</p>
<p class="project-body">After testing multiple options, I decided that only meals with instructions and a how-to video should appear on the creators recipes view. Simple, ingredient-only meals would be contained within the meal plan.</p>
<br>
<br>

![pantry tab bar wireframe](/img/pantry_flowmap.png)
<br>
<div class="caption">Mapping out the logic of adding the ‘Ingredient Only Meal’.</div>

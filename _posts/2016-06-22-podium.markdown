...
<div class="row">
  ...
  <p>What if there was a ‘Google Docs’ type solution that allowed you have multiple people work on one thing at the same time? Our goal with Podium was to create exactly that. </p>
  </div>
</div>
